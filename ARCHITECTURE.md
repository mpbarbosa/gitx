...
| --- | --- | --- |
| 1.3.2 | Command feedback in the status bar | Adds explicit per-command feedback for `git fetch --prune`, `git pull`, and `git push`, and clears stale command state when the user changes context. |
