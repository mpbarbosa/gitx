...
The format is based on [Keep a Changelog](https://keepachangelog.com/en/1.1.4/),
...
- Updated README and project architecture/requirements guidance for the v1.1.4 validation workflow.
