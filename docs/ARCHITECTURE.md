...
| ------- | ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1.3.4   | Command feedback in the status bar | Adds explicit per-command feedback for `git fetch --prune`, `git pull`, and `git push`, and clears stale command state when the user changes context.    |
...
- The project has committed format, lint, and test workflows exposed through `npm run format:check`, `npm run lint`, and `npm test`.
